...
def readLorentzVector():
  ...
  seriousHistL=[]
  cseriousHistL=[]
  sRange=[[-10,100],[-10,100],[-10,100],[-10,100],[-35,85],[-10,200],[-10,200],[0,4],[0,1]]*3
  numBin=150
  for i in range(12):
    s="seriousHist"+str(i)
  ...
  cseriousHistL[7].GetYaxis().SetTitle('N_Particles')
  ...
  cseriousHistL[8].GetYaxis().SetTitle('N_Particles')
