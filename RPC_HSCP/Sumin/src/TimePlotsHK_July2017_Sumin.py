    ...
    for event in chain:
      ...
      for i in range(n):
        if event.simDigi1_isIRPC[i]:
          if (event.simDigi1_z[i]<1000 and event.simDigi1_z[i]>900):
...
#            print r012
      ...
      if tr1 and tr2:
        ...
        chi=tr2**2+tr1**2
        HistL[5].Fill(chi)
        if dt > -5 and abs(dphi) < 0.005 and abs(deta) < 0.1:
          HistL[6].Fill(chi)
...
#  seriousHistL[7].Scale(1./norm_hscp)  # MG normalize to unity
  ...
  legend = ROOT.TLegend(0.67,0.70,0.87,0.87)
  legend.AddEntry(cseriousHistL[7],"Muons","l")
  legend.AddEntry(seriousHistL[7],"HSCP","l")
  legend.Draw()
  line1 = ROOT.TLine(-0.005,0,-0.005,50)
  line1.Draw()
  line2 = ROOT.TLine(0.005,0,0.005,50)
  line2.Draw()
...
#  cseriousHistL[8].SetMaximum(1)
  ...
  legend = ROOT.TLegend(0.67,0.70,0.87,0.87)
  legend.AddEntry(cseriousHistL[8],"Muons","l")
  legend.AddEntry(seriousHistL[8],"HSCP","l")
  legend.Draw()
  line1 = ROOT.TLine(-0.1,0,-0.1,50)
  line1.Draw()
  line2 = ROOT.TLine(0.1,0,0.1,50)
  line2.Draw()
  ...
  legend = ROOT.TLegend(0.67,0.70,0.87,0.87)
  legend.AddEntry(cseriousHistL[9],"Muons","l")
...
#  seriousHistL[10].Scale(1./norm_hscp)  # MG normalize to unity
  ...
  legend = ROOT.TLegend(0.67,0.70,0.87,0.87)
  legend.AddEntry(cseriousHistL[10],"Muons","l")
...
#  seriousHistL[11].Scale(1./norm_hscp)  # MG normalize to unity
  ...
  legend = ROOT.TLegend(0.67,0.70,0.87,0.87)
  legend.AddEntry(cseriousHistL[11],"Muons","l")
...
# MG end
  ...
  legend.AddEntry(propHist_pos,"chi2 + (dT > -5 ns)","p")
  legend.Draw() 
